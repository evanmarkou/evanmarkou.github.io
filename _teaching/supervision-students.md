...
*   **Shitong Wang** (Masters, Maths). Thesis: *Advancing parameter-free and architecture aware optimisation for deep networks* (Semester 1 & 2, 2026). Co-supervised with [Dylan Campbell](https://sites.google.com/view/djcampbell).
